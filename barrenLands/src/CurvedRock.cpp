...
CurvedRock::CurvedRock() : ProceduralRock(){
    generateVertices();
    generateIndices();
...
CurvedRock::~CurvedRock(){}
void CurvedRock::generateVertices(){
...
*/
    ...
    _vertices.emplace_back(glm::vec3(cos(0),1.2,sin(0)), glm::vec3(cos(0),0.5,sin(0)), glm::vec2(1,1));
    _vertices.emplace_back(glm::vec3(cos(2*3.14/5),1.2,sin(2*3.14/5)), glm::vec3(cos(2*3.14/5),0.5,sin(2*3.14/5)), glm::vec2(1,1));
    _vertices.emplace_back(glm::vec3(cos(4*3.14/5),1.2,sin(4*3.14/5)), glm::vec3(cos(4*3.14/5),0.5,sin(4*3.14/5)), glm::vec2(1,1));
    _vertices.emplace_back(glm::vec3(cos(6*3.14/5),1.2,sin(6*3.14/5)), glm::vec3(cos(6*3.14/5),0.5,sin(6*3.14/5)), glm::vec2(1,1));
    _vertices.emplace_back(glm::vec3(cos(8*3.14/5),1.2,sin(8*3.14/5)), glm::vec3(cos(8*3.14/5),0.5,sin(8*3.14/5)), glm::vec2(1,1));
...
void CurvedRock::generateIndices(){
    indices.clear();
}
void CurvedRock::generateNormals() {
    ProceduralRock::generateNormals();
}


void CurvedRock::subdivideObject(std::vector<glimac::ShapeVertex> &_vertices, int nbRecurse) {
    if(nbRecurse <= 0){
        return;
    }
...
Color *CurvedRock::chooseColor(Color *_color) {
    Color * alteredColor;
    if(_color == nullptr){
...
int CurvedRock::find(std::vector<glm::vec3> &tab, glm::vec3 object){
    //Chercher un objet
    int i;
...
void CurvedRock::smooth(std::vector<glimac::ShapeVertex> &_vertices, int nbRecurse) {
    if(nbRecurse <= 0){
        return;
    }
...
glm::mat4 CurvedRock::getRandomRotation() {
    return glm::rotate(glm::mat4(1.f), glm::radians(95*NoiseManager::getInstance().getRandomFloat()), glm::vec3(0,1,0));
}

glm::mat4 CurvedRock::getRandomScale() {
