...
void RenderObject::fillData(std::vector<glimac::ShapeVertex> vertices, std::vector<int> indices) {
    if(indices.empty()){
...
RenderObject::RenderObject(glcustom::GPUProgram * program) : program(program), vao() {}
