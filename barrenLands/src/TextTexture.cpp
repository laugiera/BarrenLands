...
bool TextTexture::loadFromFile(SDL_Renderer* gRenderer, std::string path )
{
...
SDL_Texture *TextTexture::getMTexture() const {
    return mTexture;
}

void TextTexture::setMTexture(SDL_Texture *mTexture) {
    TextTexture::mTexture = mTexture;
}
