...
glm::mat4 ProceduralFeuillage::getRandomScale() {
    return glm::scale(glm::mat4(1.f), glm::vec3(1.3+0.6*NoiseManager::getInstance().getRandomFloat(),1.3+0.6*NoiseManager::getInstance().getRandomFloat(),1.3+0.6*NoiseManager::getInstance().getRandomFloat()));
}
